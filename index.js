...
program
  ...
  .option('--formal', 'run formal verification via solc SMTChecker (requires solc)')
  .option('--fuzz', 'generate Foundry + Echidna invariant test scaffolds')
  .option('--panel', 'multi-AI panel: run all configured providers + consensus adjudication')
  .option('--provider <list>', 'comma-separated providers to use (e.g. anthropic,openai,ollama)')
  .option('--model <name>', 'override the model for the chosen provider (e.g. qwen2.5-coder, gpt-4o)')
